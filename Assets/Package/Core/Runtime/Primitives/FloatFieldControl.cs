...
namespace Nessle
{
    ...
    public class FloatFieldControl : PrimitiveControl<FloatFieldProps>
    {
        ...
        protected override void SetupInternal()
        {
            ...
            _inputField.onEndEdit.AddListener(x => props.value.From(float.TryParse(x, out var value) ? value : 0));
