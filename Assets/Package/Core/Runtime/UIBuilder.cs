...
namespace Nessle
{
    public static class UIBuilder
    {
        ...
        public static IControl<T> Control<T>(string identifier, T props, PrimitiveControl<T> prefab) where T : new()
        {
        ...
        public static IControl Text(string identifier = "text", TextProps props = default, PrimitiveControl<TextProps> prefab = default)
            => Control(identifier, props, prefab == null ? primitives.text : prefab);

        public static IControl Image(string identifier = "image", ImageProps props = default, PrimitiveControl<ImageProps> prefab = default)
            => Control(identifier, props, prefab == null ? primitives.image : prefab);

        public static IControl Button(string identifier = "button", ButtonProps props = default, PrimitiveControl<ButtonProps> prefab = default)
            => Control(identifier, props, prefab == null ? primitives.button : prefab);

        public static IControl HorizontalLayout(string identifier = "horizontalLayout", LayoutProps props = default, PrimitiveControl<LayoutProps> prefab = default)
            => Control(identifier, props, prefab == null ? primitives.horizontalLayout : prefab);

        public static IControl VerticalLayout(string identifier = "verticalLayout", LayoutProps props = default, PrimitiveControl<LayoutProps> prefab = default)
            => Control(identifier, props, prefab == null ? primitives.verticalLayout : prefab);

        public static IControl InputField(string identifier = "inputField", InputFieldProps props = default, PrimitiveControl<InputFieldProps> prefab = default)
