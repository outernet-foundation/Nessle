...
namespace Nessle
{
    public static class InputFieldExtensions
    {
        ...
        {
            control.AddBinding(
                bindTo.AsObservable().Subscribe(x => control.props.inputText.From(x.currentValue)),
        ...
        {
            control.AddBinding(
                bindTo.AsObservable().Subscribe(x => control.props.inputText.From(toControl(x.currentValue))),
